    ...
    <div class="page-wrapper" style="min-height: 367px;">
        ...
        <div class="container">
            ...
            <div style="font-size: 20px;">
                <h2>Nhập thông tin nhóm thiết bị</h2>
            </div>

            <hr>

            <form action="{{route('post_them_nhom_thiet_bi')}}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 offset-3">
                        ...
                        <div class="form-group">
                            ...
                            @enderror
                            <input style="width: 65%" class="form-control" type="text" name="tenNhomThietBi">
                    ...
                    <div class="col-sm-6 offset-3">
                        ...
                        <div class="form-group">
                            ...
                            @error('maNhomThietBi')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <input style="width: 65%" class="form-control" type="text" name="maNhomThietBi">
