...
@section('content')
    <div class="page-wrapper" style="min-height: 667px;">
        ...
        <div class="content">
            ...
            <!-- tìm kiếm -->
            <form action="/admin/thietbi/searchThanhLy" method="GET">
                @csrf
                <div class="content">
                    <div class="row">
            ...
            <div class="">
                <div class="tab">
                    ...
                    <a class="tablinks" href="{{ route('list_thiet_bi_thanh_ly') }}" style="background-color: #ccc;">Đã
                        thanh lý</a>
                </div>
                <br>
